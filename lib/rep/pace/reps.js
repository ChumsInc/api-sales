...
const availableRepsSQL = `
    ...
    ORDER BY SalespersonDivisionNo, SalespersonNo
`;
export async function loadRepInfo({ SalespersonDivisionNo, SalespersonNo }) {
    try {
...
export async function loadRepManagers({ SalespersonDivisionNo, SalespersonNo }) {
    try {
...
export async function loadManagedReps({ SalespersonDivisionNo, SalespersonNo, userid }) {
    try {
...
export async function loadRepPace({ SalespersonDivisionNo = '', SalespersonNo = '', minDate, maxDate, userid = 0, groupByCustomer = false }) {
    try {
