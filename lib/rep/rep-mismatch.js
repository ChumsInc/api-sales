...
const debug = Debug('chums:lib:rep:rep-mismatch');
...
const loadRepMismatch = async () => {
    ...
    try {
        ...
        if (err instanceof Error) {
            console.debug("loadRepMismatch()", err.message);
            return Promise.reject(err);
        }
        console.debug("loadRepMismatch()", err);
...
export const renderRepMismatch = async (req, res) => {
    try {
        ...
        if (err instanceof Error) {
            console.debug("renderRepMismatch()", err.message);
            return Promise.reject(err);
        }
        console.debug("renderRepMismatch()", err);
