...
router.get('/log/:Company.json', getLoggedOrders);
router.get('/log/:Company/order-type/:OrderType.json', getLoggedOrders);
router.get('/log/:Company/:SalesOrderNo.json', getLoggedOrderHistory);
router.get('/log/:Company/:minDate/:maxDate/stats.json', getLoggedOrderUserStats);
router.post('/log/:Company/:SalesOrderNo/:action.json', postLogSalesOrderAction);
...
router.get('/promo.json', getPromoCodes);
