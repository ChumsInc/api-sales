...
export function buildCustomerItemsData(data) {
    return data.map(row => {
...
export async function buildCustomerItemsExcel(data) {
    try {
        ...
        return buildWorkBook(workBookSheets) ?? null;
    }
    catch (err) {
