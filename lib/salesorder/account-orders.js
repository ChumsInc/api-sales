 ...
 * @return {Promise<void>}
 */
async function getAccountOpenOrders(req, res) {
    try {
        /**
         *
...
exports.getAccountOpenOrders = getAccountOpenOrders;
 ...
 * @return {Promise<void>}
 */
async function getAccountClosedOrders(req, res) {
    try {
        /**
         *
         * @type {LoadOrdersParams}
...
exports.getAccountClosedOrders = getAccountClosedOrders;
