...
const promoGLCodes = ['4246', '4311', '6503', '6507', '6508', '6634', '6727'];
...
const querySalesOrder = `
    SELECT d.LineKey,
           ...
           IF(h.OrderStatus = 'C',
              d.UnitCost,
              IFNULL(IFNULL(ik.AverageCost, NULLIF(iw.AverageCost, 0)) * d.UnitOfMeasureConvFactor,
