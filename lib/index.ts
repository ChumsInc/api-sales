...
import {getOrdersByPeriod} from "./salesorder/orders-by-period.js";
import {
    delNewPricingEntry,
    getAllPricing,
    getPriceChangeUsers,
...
router.get('/customer-types.json', getCustomerTypes);
router.get('/customer-types', deprecationNotice, getCustomerTypes);
...
router.get('/gdpr/:SalesOrderNo.json', getGDPRSORequest);
...
router.get('/invoice/:Company/:InvoiceType/:InvoiceNo.json', getInvoice);
router.get('/invoice/:Company/:InvoiceType/:InvoiceNo', getInvoice);
router.get('/invoice/:Company/:InvoiceNo.json', getInvoice);
...
router.get('/invoices/:Company/:ARDivisionNo-:CustomerNo.json', getAccountInvoices);
...
router.get('/orders/cm/margins.json', getCMMargins);
router.get('/orders/margins/:salesOrderNo.json', getOrderItemMargins);
router.get('/orders/margins/:company/:salesOrderNo', getOrderItemMargins);

router.get('/orders/open/:company/:ARDivisionNo-:CustomerNo.json', getAccountOpenOrders)
router.get('/orders/open/:company/:ARDivisionNo-:CustomerNo', getAccountOpenOrders)
router.get('/orders/open/:company/:salesOrderNo.json', getOpenSalesOrder);
router.get('/orders/open/:company/:salesOrderNo', getOpenSalesOrder);
router.get('/orders/by-period.json', getOrdersByPeriod);
// router.get('/orders/status/:Company/:dateType(od|sd)/:minDate/:maxDate', getOrdersByPeriod);
router.get('/orders/:salesOrderNo.json', getSalesOrder);
...
router.get('/pricing/:Company/:PriceCode', validateRole(['cost']), getPriceCode);
