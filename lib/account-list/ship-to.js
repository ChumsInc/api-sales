...
async function loadAccounts({ filters, periods, sqlSort }) {
    try {
...
export const getShipToAccountList = async (req, res) => {
    try {
...
export const renderShipToAccountList = async (req, res) => {
    try {
...
export const renderShipToAccountListXLSX = async (req, res) => {
    try {
        const { sqlSort, fields, filters, periods } = await parse(req.body, res.locals.profile.user.id);
